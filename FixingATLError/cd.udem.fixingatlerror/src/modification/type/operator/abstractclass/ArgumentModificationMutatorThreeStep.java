...
public class ArgumentModificationMutatorThreeStep extends AbstractTypeModificationMutatorThreeStep {
	...
	public List<Object> generateMutants(EMFModel atlModel, MetaModel inputMM, MetaModel outputMM, String outputFolder,ATLModel wrapper,Solution solution,CommonFunctionOperators cp) {
		...
		comments=
		this.genericTypeModification(atlModel, outputFolder, OperationCallExp.class, "arguments", new MetaModel[] {inputMM, outputMM},wrapper,solution,inputMM , outputMM,cp);
