...
public class InElementModificationMutatorThreeStep extends AbstractTypeModificationMutatorThreeStep {
	...
	public List<Object> generateMutants(EMFModel atlModel, MetaModel inputMM, MetaModel outputMM, String outputFolder,ATLModel wrapper,Solution solution,CommonFunctionOperators cp) {
		...
		comments=
		 ...
		 this.genericTypeModification(atlModel, outputFolder, InPatternElement.class, "type", new MetaModel[] {inputMM},wrapper,solution,  inputMM,  outputMM,cp);
