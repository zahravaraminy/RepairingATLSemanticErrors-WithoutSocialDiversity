...
import cd.udem.fixingatlerror.CoSolutionpostprocessing;
...
public class Solution implements Serializable {
	...
	private double fitnessthird;
	private boolean previousgeneration;
	public ArrayList<String> RHSattributerefinement = new ArrayList<String>();
	public ArrayList<Integer> RHSattributelocation = new ArrayList<Integer>();
	public ArrayList<String> Diffsubsetmodel0 = new ArrayList<String>();	
	public ArrayList<String> Diffsubsetmodel1 = new ArrayList<String>();
	public ArrayList<String> Diffsubsetmodel2 = new ArrayList<String>();
	public ArrayList<String> Diffsubsetmodel3 = new ArrayList<String>();
	...
	private double SocialDiversity_;
	...
	private CoSolutionThreeStep S3_;
	/**
	 * Constructor.
	 */
	public Solution() {
	...
	public Solution(Problem problem) throws ClassNotFoundException {
		...
		operations_ = IntSolutionTypeThreeStep.operations;
         ...
         this.filterSolution.clear();
         filterSolution=new ArrayList<String>();
         for(int l=0;l<NSGAIIThreeStep.filterasstring.size();l++)
             this.filterSolution.add(NSGAIIThreeStep.filterasstring.get(l));
         
         this.RHSattributelocation.clear();
         RHSattributelocation=new ArrayList<Integer>();
         for(int l=0;l<NSGAIIThreeStep.wholeattributargumentlocation.size();l++)
             this.RHSattributelocation.add(NSGAIIThreeStep.wholeattributargumentlocation.get(l));
         
         this.RHSattributerefinement.clear();
         RHSattributerefinement=new ArrayList<String>();
         for(int l=0;l<NSGAIIThreeStep.wholelineattributerefinement.size();l++)
             this.RHSattributerefinement.add(NSGAIIThreeStep.wholelineattributerefinement.get(l));
	...
	public Solution(Problem problem, Variable[] variables) {
		...
		variable_ = variables;
		operations_ = IntSolutionTypeThreeStep.operations;
		S3_ = IntSolutionTypeThreeStep.S;
	} // Constructor
	...
	public Solution(Solution solution) {
		...
		SocialDiversity_=solution.getSocialDiversity();
	    ...
	    this.RHSattributelocation=new ArrayList<Integer>();
	    this.RHSattributerefinement=new ArrayList<String>();
		this.modifypropertyname = new ArrayList<String>();
		this.filterSolution=new ArrayList<String>();
		...
		for (int i = 0; i < solution.operation().size(); i++) {
			...
			S3_=solution.getCoSolutionThreeStep();
	...
	public void setfitnessthird(double numop) {
		this.fitnessthird = numop;
	}
	...
	public CoSolutionThreeStep getCoSolutionThreeStep() {
		// TODO Auto-generated method stub
		return S3_;
	}
	...
	public void setCoSolutionThreeStep(CoSolutionThreeStep s_) {
		S3_ = s_;
	}
	/**
	...
	public void setSocialDiversity(double distance) {	
        SocialDiversity_ = distance;
	...
	public double getSocialDiversity() {	
    	
	    return SocialDiversity_;	
	        } // getSocialDiversity_
