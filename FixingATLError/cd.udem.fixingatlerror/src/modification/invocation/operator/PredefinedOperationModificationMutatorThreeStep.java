...
public class PredefinedOperationModificationMutatorThreeStep extends AbstractInvocationModificationMutatorThreeStep {
	...
	public List<Object> generateMutants(EMFModel atlModel, MetaModel inputMM, MetaModel outputMM, String outputFolder,ATLModel wrapper,Solution solution,CommonFunctionOperators cp) {
		...
		try {
			comment=
			this.genericAttributeModification(atlModel, outputFolder, OperationCallExp.class, "operationName", outputMM, true,wrapper,solution,cp);
