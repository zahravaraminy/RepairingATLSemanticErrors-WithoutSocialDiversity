...
public class CoSolutionpostprocessing {
	  ...
	  Operationspostprocessing op;
	  public Operationspostprocessing getOp() {
		return op;
	}
	...
	public void setOp(Operationspostprocessing op) {
		this.op = op;
	}
	 ...
	 public CoSolutionpostprocessing() 
	    {
	    	try {
				this.op=new Operationspostprocessing();
			} catch (Exception e) {
	    ...
	    CoSolutionpostprocessing(CoSolutionpostprocessing a) throws Exception
	    {
	    	this.op= a.op;
