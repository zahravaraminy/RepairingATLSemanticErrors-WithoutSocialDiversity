...
import modification.invocation.operator.abstractclass.AbstractInvocationModificationMutator;
//import modification.invocation.operator.abstractclass.AbstractInvocationModificationMutator.TYPE;
import cd.udem.fixingatlerror.Class2Rel;
import cd.udem.fixingatlerror.CommonFunctionOperators;
import jmetal.core.Solution;

public class IteratorModificationMutatorThreeStep extends AbstractInvocationModificationMutator {
	...
	public List<Object> generateMutants(EMFModel atlModel, MetaModel inputMM, MetaModel outputMM, String outputFolder,ATLModel wrapper,Solution solution,CommonFunctionOperators cp) {
		...
		try {
			comment=this.genericAttributeModification(atlModel, outputFolder, IteratorExp.class, "name", outputMM,true,wrapper,solution);
