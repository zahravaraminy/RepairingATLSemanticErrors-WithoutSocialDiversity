 ...
 */
public class SolutionThreeStep implements Serializable {
	 ...
	 */
	public SolutionThreeStep(int numberOfObjectives) {
	...
	public SolutionThreeStep(Problem problem) throws ClassNotFoundException {
		problem_ = problem;
	 ...
	 *            The problem to solve
	 */
	public SolutionThreeStep(Problem problem, Variable[] variables) {
		problem_ = problem;
		type_ = problem.getSolutionType();
		numberOfObjectives_ = problem.getNumberOfObjectives();
		objective_ = new double[numberOfObjectives_];
	 ...
	 *            Solution to copy.
	 */
	public SolutionThreeStep(SolutionThreeStep solution) {
		...
		for (int i = 0; i < solution.operation().size(); i++) {
			...
			S_ = solution.getCoSolutionThreeStep();
