 ...
 */
public abstract class ProblemThreeStep implements Serializable {
   ...
   * Constructor. 
   */
  public ProblemThreeStep(SolutionType solutionType) {
 ...
 * @param csvWriterpareto 
   */    
  public abstract void evaluate(SolutionThreeStep solution, FileWriter csvWriterpareto) throws JMException ;    
   ...
   * @param solution The <code>Solution</code> to evaluate.
   */    
  public void evaluateConstraints(SolutionThreeStep solution) throws JMException {
