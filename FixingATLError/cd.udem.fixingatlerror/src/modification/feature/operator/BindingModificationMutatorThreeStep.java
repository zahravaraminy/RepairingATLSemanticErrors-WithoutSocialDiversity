...
public class BindingModificationMutatorThreeStep extends AbstractFeatureModificationMutatorThreeStep {
	...
	public List<Object> generateMutants(EMFModel atlModel, MetaModel inputMM, MetaModel outputMM, String outputFolder,ATLModel wrapper,Solution solution,CommonFunctionOperators cp) {
		...
		comments=this.genericAttributeModification(atlModel, outputFolder, Binding.class, "propertyName", outputMM,wrapper,solution,cp);
