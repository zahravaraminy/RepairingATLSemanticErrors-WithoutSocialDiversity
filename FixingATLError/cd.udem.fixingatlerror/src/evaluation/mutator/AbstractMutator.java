...
public abstract class AbstractMutator {
	 ...
	 * @param solution 
	 * @param cp 
	 * @param ocliskindeoflocation 
	 * @param sequencelocation 
	 * @return 
	 */
	public abstract List<Object> generateMutants(EMFModel atlModel, MetaModel inputMM, MetaModel outputMM, String outputFolder, ATLModel wrapper, Solution solution, CommonFunctionOperators cp);
	 ...
	 */
	private /*static*/ long index2 = 1;
	private String getValidNameOfFile2 (String outputFolder) {
	...
	protected boolean save2 (EMFModel atlModel, String outputFolder) {
		try {
			// save atl file
